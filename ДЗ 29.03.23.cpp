...
public:
    ...
    void getReputation() {
        cout << "     Данные вашего персонажа:" << endl << 
        "          Здоровье: " << hp_gg << endl << 
        "             Урон: " << damage_gg << endl << 
        "            Броня: " << armor_gg << endl << 
        "           Выносливость: " << stamina_gg << endl << 
        "     Репутация среди Племени: " << reputation_gg_P << endl << 
        "     Репутация среди Линкольна: " << reputation_gg_L << endl;
        cout << "" << endl;
    }
...
public:
    ...
    dialog:
        ...
        cout << endl << "     1 - 'Как жизнь, боец?'" << endl << "     2 - Атаковать" << endl << "     3 - 'Бывай' (уйти)" << endl;;
        char b;
        cin >> b;
        if (b == '1') {
        srand(time(0));
        int shans_1 = rand() % 5;
           if (shans_1==0){
            cout << endl << "     –Отлично! Чувствую, сегодняшний день не принесет никаких сюрпризов по ту сторону границы." << endl;
            goto dialog;
           }
                else if (shans_1==1){
                cout << endl << "     –Пойдет. Сегодня хочу выпросить у начальства увольнительные. Давно с детьми не виделся..." << endl;
                goto dialog;
                }
                    else if (shans_1==2){
                    cout << endl << "     –Неплохо. Поскорей бы вахта закончилась..." << endl;
                    goto dialog;
                    }    
                       else if  (shans_1==3){
                        cout << endl << "     –Также прекрасно, как и твое." << endl;
                        goto dialog;
                        }
                           else if  (shans_1==4){
                            cout << endl << "     –Прекрасно, тебе такого же!" << endl;
                            goto dialog;
                            }
        }
        else if (b == '2') {
            srand(time(0));
            int shans_2 = rand() % 5;
            cout << endl << "     –А ну уходи прочь! Чтоб глаза мои тебя не видели!" << endl<< endl;
            ...
            cout << endl << "–Удачи!" ; relationships = 0;
        }
...
public:
    ...
    void move() {
        cout << endl<< endl<< "      –––––––––––––––––––––––––––––" << endl<<
                              "     |  Перед вами враждебный NPC  |" << endl<<
                              "      –––––––––––––––––––––––––––––" << endl;
    }
    ...
    void say() {
        ...
        if (shans == 0) {
            cout << endl<< "     –Не думал сегодня обнажать свой клинок" << endl;
        }
        else if (shans == 1) {
            cout << endl<< "     –К оружию!" << endl;
        }
        else if (shans == 2) {
            cout << endl<< "     –Сегодня твой последний день!" << endl;
        }
        else if (shans == 3) {
            cout << endl<< "     –Твой вид слишком невозмутим для смертника" << endl;
        }
        else if (shans == 4) {
            cout << endl<< "     –АААААРГХ *Бежит с большой скоростью на вас*" << endl;
        }
    };
};
...
public:
    ...
    void say() {
        ...
        if (shans_1 == 0) {
            cout <<  endl<< "     –Славный сегодня денек, не правда ли?" <<  endl;
        }
        else if (shans_1 == 1) {
            cout <<  endl<< "     –*шепчет* а в обед будут катлеты... С пюрешкой..."  << endl;
        }
        else if (shans_1 == 2) {
            cout <<  endl<< "     –Как здоровье, путник?"  << endl;
        }
        else if (shans_1 == 3) {
            cout <<  endl<< "     –Отлично выглядишь!"  << endl;
        }
        else if (shans_1 == 4) {
            cout <<  endl<< "     –Интересно, почему в небе так много облаков..."  << endl;
        }
...
public:
    ...
    void interctable() {
       ...
       cout << "     Данные вашего врага:" << endl << 
        "          Здоровье: " << hp << endl << 
        "             Урон: " << damage << endl << 
        "            Броня: " << armor << endl << 
        "           Выносливость: " << stamina << endl;
    }
    ...
    battleStart:
        ...
        cout << "           Враг атакует!"<<endl<<endl; 
        sleep(0.7); 
        cout<< "         Ваши действия?" << endl << "     1 - Поставить блок" << endl << "     2 - Попытаться уклониться" << endl;
        cin >> c;
...
int main() {
    ...
    //sleep(2);
    cout << endl << "     Для ходьбы вперед кнопки 'w/8'" << endl;  
    //sleep(2);
    cout << "     Для ходьбы назад кнопки 's/2'" << endl; 
    //sleep(2);
    cout << "     Для ходьбы вправо кнопки 'd/6'" << endl;
    //sleep(2);
    cout << "     Для ходьбы влево кнопки 'a/4'" << endl; 
    //sleep(2);
    cout << "     Для просмотра хар-ик персонажа анг. кнопка 'е'" << endl;
    //sleep(2);
    cout << "     Для выхода в меню кнопка '0'" << endl << endl;
    //sleep(2);
    cout << "     Должны предупредить, что каждая клетка состоит из 20м², что равняется одному ходу героя соответственно. "<<endl<<
            "     Другими словами, если сдвинетесь в правую сторону, то ваш герой сдвинется ровно на одну клетку в правую сторону." << endl << "" << endl;
    //sleep(12);
...
restart:
    ...
    cout << endl <<
      ...
      //sleep(5);
    cout << endl << "Примечание от разведки: " << endl; sleep(1);
  cout<<"    ––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––"<< endl <<
        "   | Перед вами карта местности. Электронику будет легко обнаружить, поэтому мы нашли для вас карту в бумажном виде |" << endl<<
        "   | Условные обозначения:                                                                                          |" << endl << 
        "   | & - ваша стартовая позиция, она же <нулевая координата>                                                        |" << endl <<
        "   | $ - позиции бойцов Линкольна                                                                                   |" << endl <<
        "   | @ - позиции бойцов Племени                                                                                     |" << endl <<
        "   |                                                                                                                |" << endl <<
        "   | Не забывайте что враги нападут как только вы приблизитесь. Удачи, товарищ!                                     |" << endl <<
        "    ––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––"<< endl ;
    //sleep(2);
    bool death_npc1 = 0;
    bool death_npc2 = 0;
...
loop1:
    ...
    cout<< endl<< endl<< "     Ваши действия?" << endl<< endl;
    cin >> move_gg;
    i = 1;
    ...
    if ((move_gg == '6' || move_gg == 'd') && i == 1) {
        x += 20;
        i = 0;
        cout  << "     Вы повернули на право, ваши координаты x = " << x << "  y = " << y;

    }
    else if ((move_gg == '4' || move_gg == 'a') && i == 1) {
        x -= 20;
        i = 0;
        cout  << "     Вы повернули на лево, ваши координаты x = " << x << "  y = " << y ;
    }

    else if ((move_gg == '8' || move_gg == 'w') && i == 1) {
        y += 20;
        i = 0;
        cout  << "     Вы прошли вперед, ваши координаты x = " << x << "  y = " << y ;
    }
    else if ((move_gg == '2' || move_gg == 's') && i == 1) {
        y -= 20;
        i = 0;
        cout  << "     Вы прошли назад, ваши координаты x = " << x << "  y = " << y ;
    }
